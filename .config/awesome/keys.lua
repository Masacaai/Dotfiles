...
--        {description = "run prompt", group = "launcher"}),
    ...
    awful.key({ alt,            }, "backslash",
        function()
	    awful.spawn("/home/masacaai/.local/share/JetBrains/Toolbox/apps/PyCharm-P/ch-0/213.5744.248/bin/pycharm.sh")
	end,
	{description = "Launch Pycharm Professional", group = "apps"}),
    ...
    awful.key({ win,            }, "r",
        function()
            awful.spawn("rofi -show file-browser-extended")
        end,
